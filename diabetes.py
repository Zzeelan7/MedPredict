...
st.title("Disease Prediction - Diabetes")
...
# Save model
joblib.dump(best_model, f"{model_choice}_diabetes_model.pkl")
st.success(f"Model saved as {model_choice}_diabetes_model.pkl")
