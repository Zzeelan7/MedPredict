...
st.title("Disease Prediction - Parkinson's Disease")
...
# Save model
joblib.dump(best_model, f"{model_choice}_parkinson_model.pkl")
st.success(f"Model saved as {model_choice}_parkinson_model.pkl")
